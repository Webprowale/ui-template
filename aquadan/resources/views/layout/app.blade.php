...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Aquadan Solution LTD offers professional water treatment, purification, and delivery services for residential and commercial clients." name="description">
                ...
                <div class="row g-5 mb-5 align-items-center">
                    <div class="col-lg-7">
                        <div class="position-relative mx-auto">
                            <input class="form-control rounded-pill w-100 py-3 ps-4 pe-5" type="text" placeholder="Your Email Address">
                ...
                <div class="row g-5">
                    <div class="col-md-8 ">
                        <div class="footer-item d-flex flex-column">
                            <div class="footer-item">
                                <h3 class="text-white mb-4"><i class="fas fa-hand-holding-water text-primary me-3"></i>Aquadan Solution Ltd.</h3>
                                <p class="mb-3">Aquadan Solution LTD is dedicated to providing high-quality, safe, and reliable water solutions to communities and businesses. We are committed to health and sustainability.</p>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="mailto:support@aquadan.com"><i class="fas fa-envelope me-2"></i> support@aquadan.com</a>
                            <a href="tel:+1 234 567 8900"><i class="fas fa-phone me-2"></i> +1 234 567 8900</a>
                            <a href="tel:+1 234 567 8901" class="mb-3"><i class="fas fa-print me-2"></i> +1 234 567 8901</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Aquadan Solution Ltd.</a>, All right reserved.</span>
                    </div>
