...
<head>
    <meta charset="utf-8">
    <title>Intelligence Integrated Limited</title>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-0">Experience the future today with our cutting-edge AI-powered smart devices. From intelligent home automation to personal productivity enhancers, we bring artificial intelligence to your everyday life through innovative gadgets that learn, adapt, and evolve with you.</p>
                </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Intelligence Integrated Limited</a>, All Right Reserved.

                        Designed By <a class="border-bottom" href="https://webprowale.netlify.app/">webprowale</a>
                    </div>
